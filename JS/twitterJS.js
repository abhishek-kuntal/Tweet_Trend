...
function callThis(){
    ...
    httpGetAsync("https://sfhp4ryh2j.execute-api.us-west-2.amazonaws.com/processTweet/process");
}
...
function selectItem(value) {
    if (value == null || value == "") {
        ...
        alert("We will bring you the tweets with the keyword " + value.toUpperCase() + " shortly to you.");
        globalVal=value;
        deleteMarkers()
        httpGetAsync("https://pg546npvxd.execute-api.us-west-2.amazonaws.com/Assignment2/twitter?topic="+value);
